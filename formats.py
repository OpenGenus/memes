...
#format-1 
def meme_generator_1(image_path, top_text, 
                     font_path = 'impact/impact.ttf', font_size = 9):
...
#format-2
def meme_generator_2(image_path, bottom_text, 
                     font_path = 'impact/impact.ttf', font_size = 9):
    img = Image.open(image_path)
    draw = ImageDraw.Draw(img)
    image_width, image_height = img.size
...
#format-3
def meme_generator_3(image_path, top_text, bottom_text,
                     font_path = 'impact/impact.ttf', font_size = 9):
    img = Image.open(image_path)
    draw = ImageDraw.Draw(img)
    image_width, image_height = img.size
...
#format-4
def meme_generator_4(image1_path, image2_path, top_text, 
                     bottom_text, font_path='impact/impact.ttf', font_size=9):
